...
import { Globe, Bug, Check, RotateCcw, Filter, Calendar } from 'lucide-react';
...
interface FiltersPanelProps {
  ...
  onApply: (countryId: number, taxons: string[], dateFrom: string, dateTo: string) => void;
  isLoading?: boolean;
}
...
export function FiltersPanel({
  ...
  }, [selectedCountryId, selectedTaxons, selectedDateFrom, selectedDateTo]);
  ...
  const handleApply = () => {
    onApply(draftCountryId, draftTaxons, draftDateFrom, draftDateTo);
  };
  ...
  const hasChanges =
    ...
    draftDateFrom !== selectedDateFrom ||
    draftDateTo !== selectedDateTo;
        ...
        {isExpanded && (
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none disabled:bg-gray-50 disabled:cursor-not-allowed transition-all"
                  />
                </div>
                <div className="flex-1">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Оставьте пустым, чтобы не ограничивать по дате
              </p>
            </div>
